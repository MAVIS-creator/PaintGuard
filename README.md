...
[![PowerShell Version](https://img.shields.io/badge/PowerShell-5.1%20%7C%207%2B-059669.svg)](#architecture-overview)
[![UI Framework](https://img.shields.io/badge/UI-VaultGuard%20360-3b82f6.svg)](#-quick-start-guide)
...
**VaultGuard 360** is an incident response, clean-file integrity vault, self-protecting immunity engine, and multi-family antivirus suite engineered to neutralize removable media malware and PE file infectors:
...
├── icon.ico                          # Windows Taskbar ICO icon
...
├── PaintGuard-UI.html                # VaultGuard 360 Desktop Dashboard UI
├── Modules/
...
│   ├── PaintGuard.Detection.psm1     # Legacy alias shim
│   ├── PaintGuard.Remediation.psm1    # Legacy alias shim
│   ├── PaintGuard.Persistence.psm1    # Legacy alias shim
│   ├── PaintGuard.Vaccine.psm1        # Legacy alias shim
│   ├── PaintGuard.Report.psm1         # Legacy alias shim
│   └── PaintGuard.Baseline.psm1       # Legacy alias shim
└── Tests/
